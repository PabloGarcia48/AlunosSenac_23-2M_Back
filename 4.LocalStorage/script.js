...
//Carregar os carros do back-end (localStorage) para a memória ram
...
//Adicionar os carros à lista no front-end

function addCarToList(car, index) {
    var carList = document.getElementById("car-list");
    var li = document.createElement("li");
    li.className = "list-group-item d-flex justify-content-between align-items-center";
    li.innerHTML = "<span>" + (index+1) + " - <strong>" + car.model + "</strong> - " + car.year + " - $ " + car.price + "</span>" +
